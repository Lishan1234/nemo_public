...
class FDA():
    def __init__(self, vpxdec_path, content_dir, input_video, num_threads, gop, num_visualized_frames):
...
if __name__ == '__main__':
    ...
    fda = FDA(os.path.abspath(args.vpxdec_path), os.path.abspath(args.content_dir),
                args.input_video_name, args.num_threads, args.gop, args.num_visualized_frames)
