...
class ArgsParser():
    def __init__(self,program_name,args_list):
        ...
        optional.add_argument('-x', '--set_system_params', action='store_true',
                            help='Option to set required system params to eliminate any run to run variations', required=False)
    ...
    def set_system_params(self):
        return self._args['set_system_params']
