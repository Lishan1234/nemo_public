...
def execute_network(runtime):
    ...
    cmds = ['export SNPE_TARGET_ARCH=aarch64-android-clang6.0',
            ...
            'snpe-sample -d {} {} -i {} -o ./{}'.format(os.path.join(dst_root_dir, args.train_data, 'models', model_name, 'dlc', dlc_name), runtime_opt, os.path.join(dst_root_dir, args.train_data, 'data', TARGET_RAW_LIST_FILE), output_dir),
            'exit']
