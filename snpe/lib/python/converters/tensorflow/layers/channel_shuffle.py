    ...
    def resolve_layer(self, graph_matcher, graph_helper):
        ...
        for match in graph_matcher.match_sequence(self.sequence):
            ...
            if len(reshape_in_shape) < 2:
                raise ConverterError(code_to_message.get_message('ERROR_TF_CHANNEL_SHUFFLE_RESHAPE'))
            ...
            if num_channels % num_groups != 0:
                raise ConverterError(code_to_message.get_message('ERROR_TF_CHANNEL_SHUFFLE'))
            ...
            if not is_channel_shuffle:
                raise ConverterError(code_to_message.get_message('ERROR_TF_CHANNEL_SHUFFLE_OUTPUT'))
