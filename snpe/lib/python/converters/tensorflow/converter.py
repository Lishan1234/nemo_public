...
import snpe
from snpe.common import snpe_converter_utils
...
class DlcConverter(object):
    ...
    def _assert_all_descriptors_consumed(self, descriptors, original_descriptors):
        ...
        for d in unconsumed_descriptors:
            self._logger.warning(code_to_message.get_warning_message('WARNING_TF_LAYER_NOT_CONSUMED')(d.layer_name, d.layer_type))
