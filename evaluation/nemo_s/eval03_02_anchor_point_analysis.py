...
if __name__ == '__main__':
    ...
    #log: out-degree
    out_degree_log_dir =os.path.join(dataset_dir, 'log', lr_video_name)
    ...
    with open(log_file, 'w') as f:
        #|anchor points|
        nemo_log_dir = os.path.join(dataset_dir, 'log', lr_video_name, nemo_s.name, '{}_{}'.format(APS_NEMO.NAME1, args.threshold))
        ...
        #Uniform
        uniform_log_dir = os.path.join(dataset_dir, 'log', lr_video_name, nemo_s.name, '{}_{}'.format(APS_Uniform.NAME1, num_anchor_points))
        ...
        #Random
        random_log_dir = os.path.join(dataset_dir, 'log', lr_video_name, nemo_s.name, '{}_{}.tmp'.format(APS_Random.NAME1, num_anchor_points))
