    ...
    do
        ...
        do
            ...
            do
                ...
                CUDA_VISIBLE_DEVICES=${gpu_index} python ${NEMO_ROOT}/evaluation/latency/evaluate.py --data_dir ${NEMO_ROOT}/data --content ${content}${index} --video_name ${resolution}p_${bitrate}kbps_s0_d300.webm --num_blocks ${num_blocks} --num_filters ${num_filters} --algorithm=${algorithm} --device_id=${device_id}
            done
        done
    done
done
