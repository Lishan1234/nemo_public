...
if __name__ == '__main__':
    ...
    parser.add_argument('--device_rootdir', type=str, required=True)

    args = parser.parse_args()

    #setup directory
    device_video_dir = os.path.join(args.device_rootdir, 'video')
    ...
    device_checkpoint_dir = os.path.join(args.device_rootdir, 'checkpoint', model.name)
