...
static void decode_hr(mobinas_cfg_t *mobinas_cfg, const char *hr_video_file)
{
    //name
...
static void decode_lr(mobinas_cfg_t *mobinas_cfg, const char *lr_video_file)
{
    //name
...
static void decode_bilinear_lr(mobinas_cfg_t *mobinas_cfg, const char *lr_video_file, const char *hr_video_file)
{
    //name
    strcpy(mobinas_cfg->target_file, lr_video_file);
...
static void decode_sr(mobinas_cfg_t *mobinas_cfg, const char *hr_video_file, const char *sr_video_file)
{
    //name
