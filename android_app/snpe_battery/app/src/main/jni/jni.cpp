...
JNIEXPORT void JNICALL Java_com_example_snpesample_SNPEActivity_function1
...
//	const char * o = "/storage/emulated/0/Android/data/com.example.snpesample/files/output_sample";
    ...
    if(model == 1){
	    //b2
        __android_log_print(ANDROID_LOG_ERROR, "YO", "hi jni fine");
	...
	fake_main(name,b,d,i,o,minutes);
	// test(name,b,d,i,o);
