...
if __name__ == '__main__':
    ...
    for model in models:
        ...
        latency_log = os.path.join(args.dataset_rootdir, args.reference_content, 'log', video_name, model.name, cache_profile_name, args.device_id, 'latency.txt')
        metadata_log = os.path.join(args.dataset_rootdir, args.reference_content, 'log', video_name, model.name, cache_profile_name, args.device_id, 'metadata.txt')
