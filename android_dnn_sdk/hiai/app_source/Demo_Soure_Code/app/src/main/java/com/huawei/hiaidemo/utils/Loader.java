...
public class Loader {
    ...
    public static Model createModel(final File modelDir, final File dataDir, final String modelName) {
        final Model model = new Model();
        model.modelName = modelName;
        model.offlineModel = new File(modelDir, modelName + OFFLINE_EXT);
        final File Lrimages = new File(dataDir, LR_IMAGES_FOLDER_NAME);
        ...
        final File Hrimages = new File(dataDir, HR_IMAGES_FOLDER_NAME);
