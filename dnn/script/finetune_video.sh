...
do
    ...
    do
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=${gpu_index} python ${NEMO_ROOT}/dnn/train_video.py --data_dir ${NEMO_ROOT}/data --content ${content} --lr_video_name ${resolution}p_${bitrate}kbps_s0_d300.webm --hr_video_name 2160p_s0_d300.webm --num_blocks ${num_blocks} --num_filters ${num_filters} --load_on_memory --finetune_from_div2k
        done
    done
done
