...
from dnn.model.nas_s_y import NAS_S_Y
...
if __name__ == '__main__':
    ...
    #dnn
    nas_s_y = NAS_S_Y(args.num_blocks, args.num_filters, scale)
    if (hr_video_profile['height'] % lr_video_profile['height'] == 0 and
            hr_video_profile['width'] % lr_video_profile['width'] == 0):
        model = nas_s_y.build_model()
    else:
        model = nas_s_y.build_model(resolution=(hr_video_profile['height'], hr_video_profile['width']))
